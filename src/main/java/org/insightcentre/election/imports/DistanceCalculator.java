...
//        }
        ...
        public static double distance(MapLocation a, MapLocation b){
            return distance(a.getCentroidX(),a.getCentroidY(),b.getCentroidX(),b.getCentroidY());
//            return distance(a.getLongitude(),a.getLatitude(),b.getLongitude(),b.getLatitude(),"K");
        }
