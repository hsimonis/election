...
public class ProvinceController extends Table3Controller {
	@FXML
	private TableView<Province> table;

	@FXML
	private TableColumn<Province, String> name;

	@FXML
	private TableColumn<Province, String> shortName;

	@FXML
	private TableColumn<Province, Double> longitude;

	@FXML
	private TableColumn<Province, Double> latitude;

	@FXML
	private TableColumn<Province, String> ident;

	@FXML
	private TableColumn<Province, Double> xMin;

	@FXML
	private TableColumn<Province, Double> xMax;

	@FXML
	private TableColumn<Province, Double> yMin;

	@FXML
	private TableColumn<Province, Double> yMax;

	@FXML
	private TableColumn<Province, Integer> totalPopulation;

	@FXML
	private TableColumn<Province, Double> totalArea;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getProvinceData());
	}

	public TableView<Province> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getProvinceData());
		try {
			ObservableList<Province> filteredItems = FXCollections.observableArrayList();
			for (Province item : table.getItems()) {
