...
public class Nuts3Controller extends Table3Controller {
	@FXML
	private TableView<Nuts3> table;

	@FXML
	private TableColumn<Nuts3, String> name;

	@FXML
	private TableColumn<Nuts3, String> shortName;

	@FXML
	private TableColumn<Nuts3, Double> longitude;

	@FXML
	private TableColumn<Nuts3, Double> latitude;

	@FXML
	private TableColumn<Nuts3, String> ident;

	@FXML
	private TableColumn<Nuts3, Double> xMin;

	@FXML
	private TableColumn<Nuts3, Double> xMax;

	@FXML
	private TableColumn<Nuts3, Double> yMin;

	@FXML
	private TableColumn<Nuts3, Double> yMax;

	@FXML
	private TableColumn<Nuts3, Integer> totalPopulation;

	@FXML
	private TableColumn<Nuts3, Double> totalArea;
	...
	public void setMainApp(AbstractJfxMainWindow app) {
		...
		table.setItems(mainApp.getNuts3Data());
	}

	public TableView<Nuts3> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getNuts3Data());
		try {
			ObservableList<Nuts3> filteredItems = FXCollections.observableArrayList();
			for (Nuts3 item : table.getItems()) {
