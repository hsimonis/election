...
public class DistanceErrorController extends Table3Controller {
	...
	@FXML
	private TableColumn<DistanceError, String> name;

	@FXML
	private TableColumn<DistanceError, MapLocation> from;

	@FXML
	private TableColumn<DistanceError, MapLocation> to;
	...
	public TableView<DistanceError> getTable() {
		return table;
	}
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getDistanceErrorData());
		try {
			ObservableList<DistanceError> filteredItems = FXCollections.observableArrayList();
			for (DistanceError item : table.getItems()) {
