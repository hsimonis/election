...
public class ShapedController extends Table3Controller {
	...
	@FXML
	private TableColumn<Shaped, String> name;
	...
	@FXML
	private TableColumn<Shaped, Double> xMax;

	@FXML
	private TableColumn<Shaped, Double> yMin;

	@FXML
	private TableColumn<Shaped, Double> yMax;
	...
	public void filter(String attribute, String comparison, String text) {
		table.setItems(mainApp.getShapedData());
		try {
			ObservableList<Shaped> filteredItems = FXCollections.observableArrayList();
			for (Shaped item : table.getItems()) {
